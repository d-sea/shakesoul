...
<div><?php echo $KS_Admin->dropdown_categories('default_email_category', get_option('default_email_category')); ?>
</div>
...
<p><a href="<?php echo attribute_escape($Ktai_Entry->retrieve_url()); ?>"><?php _e('Retrieve new mail posts', 'ktai_style'); ?></a><br /><?php _e('(After checking, back to here by using "Back" feature of your terminal.)', 'ktai_style'); ?></p>
<?php
}
