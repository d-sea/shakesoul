...
$menu[5] = array(__('Write Post'), 'edit_posts', 'post-new.php');
$menu[10] = array(__('Manage Posts', 'ktai_style'), 'edit_posts', 'edit.php');
$menu[15] = array(__('Comments'), 'edit_posts', 'edit-comments.php');
$menu[35] = array(__('Profile'), 'read', 'profile.php');
$menu[40] = array(__('Options'), 'manage_options', 'options-cat.php');

$submenu['edit-comments.php'][5] = array(__('All Comments', 'ktai_style'), 'edit_posts', 'edit-comments.php');
$awaiting_mod = $wpdb->get_var("SELECT COUNT(*) FROM $wpdb->comments WHERE comment_approved = '0'");
$submenu['edit-comments.php'][25] = array(sprintf(__("Awaiting Moderation (%s)", 'ktai_style'), $awaiting_mod), 'edit_posts', 'moderation.php');
...
$submenu['options-cat.php'][20] = array(__('Mobile Theme', 'ktai_style'), 'manage_options', 'options-theme.php');
