...
<a href="<?php echo get_request_uri()."&showinfo=y" ?>" title=""><img src="<?php echo $cforms_root; ?>/images/cfii.gif" alt="" align="right"/></a><img src="<?php echo $cforms_root; ?>/images/p2-title.jpg" alt=""/>
			...
			<div id="o28">
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR">
						<div id="r16" class="rbox"><textarea rows="80px" cols="200px" name="cforms_commentsuccess" id="cforms_commentsuccess"><?php echo stripslashes(htmlspecialchars($cformsSettings['global']['cforms_commentsuccess'])); ?></textarea><div id="rh16"></div></div>
					</div>
				</div>

				<div class="optionsboxSEP"></div>

				<div class="optionsbox" style="margin-bottom:5px;">
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR"><input type="text" id="cforms_commentWait" name="cforms_commentWait" value="<?php echo stripslashes(htmlspecialchars( $cformsSettings['global']['cforms_commentWait'] )); ?>"/></div>
				</div>
				<div class="optionsbox" style="margin-top:15px;">
					...
					<div class="optionsboxR"><input type="text" id="cforms_commentParent" name="cforms_commentParent" value="<?php echo stripslashes(htmlspecialchars( $cformsSettings['global']['cforms_commentParent'] )); ?>"/><br /><a class="infobutton" href="#" name="it8"><?php _e('Note &raquo;', 'cforms'); ?></a></div>
				...
				<div class="optionsbox" style="margin-top:15px;">
					...
					<div class="optionsboxR"><input type="text" id="cforms_commentInMod" name="cforms_commentInMod" value="<?php echo stripslashes(htmlspecialchars( $cformsSettings['global']['cforms_commentInMod'] )); ?>"/></div>
				</div>

				<div class="optionsbox" style="margin-top:15px;">
					<div class="optionsboxL"><label for="cforms_commentHTML"><strong><?php _e('New comment HTML template', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR" style="margin-bottom:10px;">
						<div id="r17" class="rbox"><textarea rows="80px" cols="200px" name="cforms_commentHTML" id="cforms_commentHTML"><?php echo stripslashes(htmlspecialchars($cformsSettings['global']['cforms_commentHTML'])); ?></textarea><div id="rh17"></div></div><a class="infobutton" href="#" name="it9"><?php _e('Supported Variables &raquo;', 'cforms'); ?></a>&nbsp;&nbsp;&nbsp;<a class="infobutton" href="#" name="it9b"><?php _e('Default Template &raquo;', 'cforms'); ?></a>
						<br />
					</div>
...
&lt;/li&gt;<br />
				...
				<div class="optionsbox" style="margin-top:10px;margin-bottom:5px;">
					<div class="optionsboxL"></div><div class="optionsboxR"><strong><?php _e('Avatar Settings', 'cforms'); ?></strong></div>
				</div>

				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_avatar"><strong><?php _e('Size (in pixel)', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="text" id="cforms_avatar" name="cforms_avatar" value="<?php echo stripslashes(htmlspecialchars( $cformsSettings['global']['cforms_avatar'] )); ?>"/></div>
				</div>
		...
		<fieldset id="inandexclude" class="cformsoptions">
			...
			<div id="o27">
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR"><input type="text" id="cforms_include" name="cforms_include" value="<?php echo stripslashes(htmlspecialchars( $cformsSettings['global']['cforms_include'] )); ?>"/><br /><?php _e('Leave empty to enable for your entire blog', 'cforms') ?></div>
				</div>
			</div>
		</fieldset>
		...
		<fieldset id="popupdate" class="cformsoptions">
			...
			<div id="o9">
				...
				<div class="optionsbox" style="margin-top:15px;">
					...
					<div class="optionsboxR"><input type="text" id="cforms_dp_date" name="cforms_dp_date" value="<?php echo stripslashes(htmlspecialchars( $cformsSettings['global']['cforms_dp_date'] )); ?>"/></div>
				</div>
				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_dp_days"><strong><?php _e('Days (Columns)', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="text" id="cforms_dp_days" name="cforms_dp_days" value="<?php echo stripslashes(htmlspecialchars( $cformsSettings['global']['cforms_dp_days'] )); ?>"/></div>
				</div>
				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_dp_months"><strong><?php _e('Months', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="text" id="cforms_dp_months" name="cforms_dp_months" value="<?php echo stripslashes(htmlspecialchars( $cformsSettings['global']['cforms_dp_months'] )); ?>"/></div>
				</div>
				<div class="optionsbox">
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR"><input type="text" id="cforms_dp_start" name="cforms_dp_start" value="<?php echo stripslashes(htmlspecialchars( $cformsSettings['global']['cforms_dp_start'] )); ?>"/> <?php _e('0=Sunday, 1=Monday, etc.', 'cforms'); ?></div>
				</div>
		...
		<fieldset id="smtp" class="cformsoptions">
			...
			<div id="o10">
				...
				<div class="optionsbox" style="padding-top:10px;">
				...
				<div class="optionsbox" style="padding-top:10px;">
					<div class="optionsboxL"></div>
					<div class="optionsboxR"><strong><?php _e('SMTP Authentication (leave blank if not needed!):', 'cforms'); ?></strong></div>
				</div>
				<div class="optionsbox">
				...
				<div class="optionsbox">
					<div class="optionsboxL"></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_smtp_pop" name="cforms_smtp_pop" value="1" <?php if($smtpsettings[6]=="1") echo "checked=\"checked\""; ?>/><label for="cforms_smtp_pop"><strong><?php _e('POP before SMTP', 'cforms') ?></strong></label></div>
				</div>

				<?php if( $smtpsettings[6]=="1" ): ?>
				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_smtp_pop_host"><strong><?php _e('POP server address', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="text" id="cforms_smtp_pop_host" name="cforms_smtp_pop_host" value="<?php echo stripslashes(htmlspecialchars($smtpsettings[7])); ?>"/></div>
				</div>
				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_smtp_pop_port"><strong><?php _e('POP Port', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="text" id="cforms_smtp_pop_port" name="cforms_smtp_pop_port" value="<?php echo stripslashes(htmlspecialchars($smtpsettings[8])); ?>"/></div>
				</div>
				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_smtp_pop_ln"><strong><?php _e('POP Login', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="text" id="cforms_smtp_pop_ln" name="cforms_smtp_pop_ln" value="<?php echo stripslashes(htmlspecialchars($smtpsettings[9])); ?>"/></div>
				</div>
				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_smtp_pop_pw"><strong><?php _e('POP Password', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="text" id="cforms_smtp_pop_pw" name="cforms_smtp_pop_pw" value="<?php echo str_repeat('*',strlen($smtpsettings[10])); ?>"/></div>
				</div>
                <?php endif; ?>
		...
		<fieldset id="upload" class="cformsoptions">
			...
			<div id="o11">
				...
				<div class="optionsbox" style="margin-top:15px;">
					...
					<div class="optionsboxR">
						<div id="r8" class="rbox"><textarea rows="80px" cols="280px" class="errmsgbox" name="cforms_upload_err5" id="cforms_upload_err5" ><?php echo stripslashes(htmlspecialchars($cformsSettings['global']['cforms_upload_err5'])); ?></textarea><div id="rh8"></div></div>
					</div>
				</div>
				...
				<div class="optionsbox" style="margin-top:3px;">
					...
					<div class="optionsboxR">
						<div id="r9" class="rbox"><textarea rows="80px" cols="280px" class="errmsgbox" name="cforms_upload_err1" id="cforms_upload_err1" ><?php echo stripslashes(htmlspecialchars($cformsSettings['global']['cforms_upload_err1'])); ?></textarea><div id="rh9"></div></div>
					</div>
				</div>
				...
				<div class="optionsbox" style="margin-top:3px;">
					...
					<div class="optionsboxR">
						<div id="r10" class="rbox"><textarea rows="80px" cols="280px" class="errmsgbox" name="cforms_upload_err2" id="cforms_upload_err2" ><?php echo stripslashes(htmlspecialchars($cformsSettings['global']['cforms_upload_err2'])); ?></textarea><div id="rh10"></div></div>
					</div>
				</div>
				...
				<div class="optionsbox" style="margin-top:3px;">
					...
					<div class="optionsboxR">
						<div id="r11" class="rbox"><textarea rows="80px" cols="280px" class="errmsgbox" name="cforms_upload_err3" id="cforms_upload_err3" ><?php echo stripslashes(htmlspecialchars($cformsSettings['global']['cforms_upload_err3'])); ?></textarea><div id="rh11"></div></div>
					</div>
				</div>
				...
				<div class="optionsbox" style="margin-top:3px;">
					...
					<div class="optionsboxR">
						<div id="r12" class="rbox"><textarea rows="80px" cols="280px" class="errmsgbox" name="cforms_upload_err4" id="cforms_upload_err4" ><?php echo stripslashes(htmlspecialchars($cformsSettings['global']['cforms_upload_err4'])); ?></textarea><div id="rh12"></div></div>
					</div>
				</div>
		...
		<fieldset id="wpeditor" class="cformsoptions">
			...
			<div id="o12">
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR"><input type="checkbox" id="cforms_show_quicktag" name="cforms_show_quicktag" <?php if($cformsSettings['global']['cforms_show_quicktag']=="1") echo "checked=\"checked\""; ?>/> <label for="cforms_show_quicktag"><strong><?php _e('Enable TinyMCE', 'cforms') ?></strong> <?php _e('&amp; Code editor buttons', 'cforms') ?></label></div>
				</div>

				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_show_quicktag_js"><strong><?php _e('Fix TinyMCE error', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_show_quicktag_js" name="cforms_show_quicktag_js" <?php if( $cformsSettings['global']['cforms_show_quicktag_js']==true) echo "checked=\"checked\""; ?>/> <?php _e('Select in case you experience a TinyMCE editor error caused by other plugins.', 'cforms') ?></div>
				</div>
			</div>
		</fieldset>
		...
		<fieldset id="captcha" class="cformsoptions">
			...
			<div id="o26">
				...
				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_cap_fo"><strong><?php _e('Force display', 'cforms') ?></strong></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_cap_fo" name="cforms_cap_fo" value="1" <?php if($cap['fo']) echo "checked=\"checked\""; ?>/><label for="cforms_cap_fo"><?php _e('Force CAPTCHA display for logged in users', 'cforms') ?></label></div>
				</div>
				...
				<div class="optionsbox" style="margin-top:10px;">
					...
					<div class="optionsboxL"></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_cap_i" name="cforms_cap_i" value="i" <?php if($cap['i']=='i') echo "checked=\"checked\""; ?>/><label for="cforms_cap_i"><?php _e('User response is treated case insensitive', 'cforms') ?></label></div>
				</div>
		...
		<fieldset id="visitorv" class="cformsoptions">
			...
			<div id="o13">
				...
				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_cap_foqa"><strong><?php _e('Force display', 'cforms') ?></strong></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_cap_foqa" name="cforms_cap_foqa" value="1" <?php if($cap['foqa']) echo "checked=\"checked\""; ?>/><label for="cforms_cap_foqa"><?php _e('Force Q&A display for logged in users', 'cforms') ?></label></div>
				</div>
				...
				<div class="optionsbox" style="margin-top:10px;">
					...
					<div class="optionsboxR">
						<div id="r13" class="rbox"><textarea rows="80px" cols="280px" name="cforms_codeerr" id="cforms_codeerr" ><?php echo stripslashes(htmlspecialchars($cformsSettings['global']['cforms_codeerr'])); ?></textarea><div id="rh13"></div></div>
					</div>
				</div>
		...
		<fieldset id="tracking" class="cformsoptions">
			...
			<div id="o14">
				...
				<div class="optionsbox" style="margin-top:10px;">
					<div class="optionsboxL"><label for="cforms_database"><strong><?php _e('Enable Database Tracking', 'cforms') ?></strong></label></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_database" name="cforms_database" <?php if($cformsSettings['global']['cforms_database']=="1") echo "checked=\"checked\""; ?>/> <?php _e('Will create two new tables in your WP database.', 'cforms') ?></div>
				</div>

				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_showdashboard"><strong><?php _e('Show on dashboard', 'cforms') ?></strong></label></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_showdashboard" name="cforms_showdashboard" <?php if($cformsSettings['global']['cforms_showdashboard']=="1") echo "checked=\"checked\""; ?>/> <?php _e('Make sure to enable your forms individually as well!', 'cforms') ?></div>
				</div>

				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_rss"><strong><?php _e('Enable global RSS', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_rss" name="cforms_rss" <?php if( $cformsSettings['global']['cforms_rssall'] ) echo "checked=\"checked\""; ?>/> <?php _e('Enables an RSS feed to track all new submissions across all forms.', 'cforms'); ?></div>
				</div>
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR"><input name="cforms_rsscount" id="cforms_rsscount" value="<?php echo $cformsSettings['global']['cforms_rssall_count'];  ?>" /></div>
				</div>
				<div class="optionsbox">
					<div class="optionsboxL" style="margin-top:4px;"><label for="cforms_rsskey"><strong><?php _e('RSS Feed Security Key', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR">
				...
				<div class="optionsbox" style="margin-top:25px;">
					<div class="optionsboxL"><label for="deletetables"><?php _e('<strong>Wipe out</strong> all collected data and drop tables.', 'cforms') ?></label></div>
