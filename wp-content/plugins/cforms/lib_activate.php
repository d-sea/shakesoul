...
$cformsSettings['global']['cforms_root'] = $cr . $cformsSettings['global']['plugindir'];
...
setINI('form','cforms_header_html', '<p style="font:1em arial; font-weight:bold;">' . __('a form has been submitted on {Date}, via: {Page} [IP {IP}]', 'cforms') . '</p>' );
...
setINI('global','cforms_style_fs_td', 'font:bold 1.2em Arial; letter-spacing:2px; border-bottom:2px solid #7babfb; padding:10px 0 5px; text-align:center; background:#ddecff;');
setINI('global','cforms_style_data_td', 'font-weight:bold; padding-right:20px; vertical-align:top;');
setINI('global','cforms_style_datablock', 'background:#c1ddff; width:90%; padding:2px;');
setINI('global','cforms_style_cforms', 'font:normal 10px Arial; color:#777;');
