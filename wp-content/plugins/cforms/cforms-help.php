...
<img src="<?php echo $cforms_root; ?>/images/cfii.gif" alt="" align="right"/><img src="<?php echo $cforms_root; ?>/images/p4-title.jpg" alt=""/>
			...
			<ol style="margin:10px 0 0 100px;">
				<li><?php echo sprintf(__('First take a look at the <a href="%s">default form</a>', 'cforms'),'?page=' . $plugindir . '/cforms-options.php#anchorfields'); ?>
					<ul style="margin:10px 0 0 30px;">
						<li><?php _e('Verify that it contains all the fields you need, are they in the right order', 'cforms'); ?> <img src="<?php echo $cforms_root; ?>/images/move.gif" alt="" title=""/>?</li>
						<li><?php _e('Check the field labels (field names), if needed make your adjustments', 'cforms'); ?> <img src="<?php echo $cforms_root; ?>/images/wrench.gif" alt="" title=""/>.</li>
		...
		<div id="o18">
			<p><strong><?php _e('Editing posts and pages:', 'cforms'); ?></strong></p>
		...
		<div id="o19">
			...
			<p class="ex" style="display:none;" id="it14"><?php _e('While the <em>Field Names</em> are usually just the label of a field (e.g. "Your Name"), they can contain additional information to support special functionality (e.g. default values, regular expressions for extended field validation etc.)', 'cforms'); ?></p>
...
[...]<br />
			...
			<tr>
				<td class="ball" colspan="2">
					...
					<ol>
						...
						<li><?php _e('Edit your WP Theme template for comments. Remove the current <strong><u>form tag</u></strong> entirely (<code  style="color:red">&lt;form action=&quot;...&lt;/form&gt;</code>). Instead replace with a PHP call to cforms: <code  style="color:red">&lt;?php insert_cform(X); ?&gt;</code> with <strong>X</strong> being <u>omitted</u> if the form is your default form or starting at <strong>\'2\'</strong> (with single quotes!) for any subsequent form #.', 'cforms'); ?></li>
		...
		<table class="hf" cellspacing="2" border="4" width="95%">
			...
			<tr>
				<td class="bleft"><?php _e('Special Example:<br />comparing two input fields', 'cforms'); ?></td><td class="bright">
					<code><?php _e('please repeat email', 'cforms'); ?>||cf2_field_2</code></td>
			</tr>
			<tr>
				<td class="ball" colspan="2">
			...
			<tr>
				<td class="ball" colspan="2">
					<?php echo '<strong>'.__('Important:','cforms').'</strong>';?><br />
					<?php _e('<strong>If you need to compare two input fields (e.g. email verification):</strong> simply use the regexp field (see special example above, to point to the <u>HTML element ID</u> of the field you want to compare the current one to. To find the <u>HTML element ID</u> you would have to look into the html source code of the form (e.g.', 'cforms'); ?> <code>cf2_field_2</code>).
				</td>
			</tr>
		</table>
	</div>
	    ...
	    <h3 id="customerr"><a class="helptop" href="#top"><?php _e('top', 'cforms'); ?></a><a id="b20" class="blindminus" onfocus="this.blur()" onclick="toggleui(20);return false;" href="#" title="<?php _e('Expand/Collapse', 'cforms') ?>"></a><span class="h3title-no">4.</span><?php _e('Custom error messages &amp; input field titles', 'cforms'); ?></h3>
	    ...
	    <h3 id="hook"><a class="helptop" href="#top"><?php _e('top', 'cforms'); ?></a><a id="b21" class="blindminus" onfocus="this.blur()" onclick="toggleui(21);return false;" href="#" title="<?php _e('Expand/Collapse', 'cforms') ?>"></a><span class="h3title-no">5.</span><?php _e('Advanced: cforms APIs & (Post-)Processing of submitted data', 'cforms'); ?></h3>
		...
		<div id="o21">
			...
			<table class="hf" cellspacing="2" border="4" width="95%">
				...
				<tr>
					...
					<td class="bright"><code><?php _e('This function will return a set of stored form submissions in a multi-dimensional array.', 'cforms'); ?></code></td>
				</tr>
				<tr>
					<td class="bleft"><strong><code class="codehighlight">$fname</code></strong></td>
					<td class="bright"><code><?php _e('text string (regexp pattern) :: e.g. the form name', 'cforms'); ?></code></td>
				</tr>
				<tr>
					<td class="bleft"><strong><code class="codehighlight">$from, $to</code></strong></td>
					<td class="bright"><code><?php _e('DATETIME string (format: Y-m-d H:i:s) :: date & time defining the target period, e.g.', 'cforms'); ?><strong style="color:red;"> 2008-09-17 15:00:00</strong></code></td>
				</tr>
				<tr>
					<td class="bleft"><strong><code class="codehighlight">$sort</code></strong></td>
					<td class="bright"><code><?php _e('text ::', 'cforms'); ?> <strong style="color:red;">form_id</strong>, <strong style="color:red;">id</strong>, <strong style="color:red;">sub_date</strong>, <strong style="color:red;">ip</strong> <?php _e('or', 'cforms'); ?> <strong style="color:red;">email</strong></code></td>
				</tr>
				<tr>
					<td class="bleft"><strong><code class="codehighlight">$limit</code></strong></td>
					<td class="bright"><code><?php _e('number :: limits the number of results, \'\' (empty) = no limits!', 'cforms'); ?></code></td>
				</tr>
				<tr>
					<td class="ball" colspan="2">
						<?php _e('<strong>Examples', 'cforms'); ?>
					</td>
				</tr>
				<tr>
					<td class="ball" colspan="2">
			...
			<p><?php _e('my-functions.php can reside in your /plugins/custom-cforms folder to protect it from future (auto) upgrades.', 'cforms'); ?></p>
		</div>
...
...</code></pre>
		...
		<div id="o23">
			...
			<table class="hf" cellspacing="2" border="4">
				...
				<tr>
					<td class="bleft">{PostID}</td>
					<td class="bright"><code><?php _e('Inserts the ID of the post the form is shown in.', 'cforms'); ?></code></td>
				</tr>
				<tr>
					<td class="bleft">{Referer}</td>
					<td class="bright"><code><?php _e('Inserts the HTTP referer information (if available).', 'cforms'); ?></code></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="bleft">{<em><?php _e('field label', 'cforms'); ?></em>}</td>
					<td class="bright"><code><?php _e('With <em>field label</em> being the <u>exact</u> field label as it is being tracked and sent in the admin email!', 'cforms'); ?></code></td>
				</tr>
				<tr>
					<td class="bleft">{<em><?php _e('XYZ', 'cforms'); ?></em>}</td>
					<td class="bright"><code><?php _e('In case you\'re using the <u>custom input field NAMES & ID\'s</u>, the reference is the <u>id:</u> of the field.', 'cforms'); ?></code></td>
				</tr>
				<tr>
					<td class="bleft">{<em>_field<strong>NN</strong></em>}</td>
					<td class="bright"><code><?php _e('With <em>NN</em> being the position of the field on the form configuration page.', 'cforms'); ?></code></td>
				</tr>
