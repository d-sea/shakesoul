...
function cforms_options_page_style() {
	...
	if ( strpos($request_uri,'cforms-options')!==false ){
		echo '<script type="text/javascript" src="' . $cformsSettings['global']['cforms_root'] . '/js/cformsadmincal.js"></script>' .
			 '<link rel="stylesheet" type="text/css" href="' . $cformsSettings['global']['cforms_root'] . '/styling/calendar.css" />' . "\n";
