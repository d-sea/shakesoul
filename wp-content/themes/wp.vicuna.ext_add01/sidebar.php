<div id="utilities">
	<dl class="navi">
                <dt><?php _e('Service'); ?></dt>
                <dd>
                    <ul class="links">
				       <li class="link2"><a href="services/amazon-ec2-パック"></a></li>
                    </ul>
                </dd>
...
setup_postdata($post);
?>
		<li><?php the_category('-'); ?> : <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> (<?php the_time('y/m/d'); ?>)</li>
<?php } ?>
			</ul>
		</li>
		</dd>
		...
		<dd>
			<ul class="links">
                                <li class="link"><a href="http://www.fhy-works.com" target="_blank">
</a></li>
                        </ul>
		</dd>
	</dl><!--end others-->
