...
<!--
		...
		<dd>
			<ul class="meta">
				<li><a href="http://validator.w3.org/check/referer" title="<?php _e('This page validates as XHTML 1.0 Strict', 'vicuna'); ?>" rel="nofollow"><?php _e('Valid <abbr title="eXtensible HyperText Markup Language">XHTML</abbr>', 'vicuna'); ?></a></li>
<?php		wp_register(); ?>
